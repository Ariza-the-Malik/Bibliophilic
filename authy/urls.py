...
from authy.views import UserProfile, Signup, PasswordChange, PasswordChangeDone, EditProfile, book, Book_Details,rating_process, searchBook1,userlist, UserSearch1
from . import views
